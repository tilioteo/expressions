...
public class Constant extends Primitive {
	...
	public Constant(String value) {
		...
		if (value.startsWith(StringConstants.STR_DOUBLE_QUOTE) && value.endsWith(StringConstants.STR_DOUBLE_QUOTE)) {
	...
	public String toString() {
		...
		if (type == String.class) {
			return value != null ? StringConstants.STR_DOUBLE_QUOTE + value + StringConstants.STR_DOUBLE_QUOTE
					: "<null>";
